...
class _EditRecordScreenState extends State<EditRecordScreen> {
  ...
  void initState() {
    ...
    _selectedType = widget.record.type == 'debit' ? 'expense' : 'income';
    _selectedAccountId = widget.record.accountId;
    _selectedCategoryId = widget.record.categoryId;
    _selectedGoalId = widget.record.goalId;
    _selectedLiabilityId = widget.record.liabilityId;
    _selectedDate = widget.record.timestamp;
    _loadData();
  }
